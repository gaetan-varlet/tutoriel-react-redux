...
export function getCountries(){
    return function(dispatch){
        axios.get(`${API_END_POINT}countries`
...
export function getMortality(country){
    return function(dispatch){
        return axios.get(`${API_END_POINT}mortality-distribution/${country}/male/${DEFAULT_PARAM}`
               ).then(function(responseMale){
                    axios.get(`${API_END_POINT}mortality-distribution/${country}/female/${DEFAULT_PARAM}`
                    ).then(function(responseFemale){
